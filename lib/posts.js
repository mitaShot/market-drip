...
export function getSortedPostsData() {
    ...
    const allPostsData = Object.values(postsById).map(post => {
        ...
        // Aggregate ALL tags from all variations
        const allTags = new Set();
        variationLangs.forEach(lang => {
            if (post.variations[lang].tags) {
                post.variations[lang].tags.forEach(t => allTags.add(t));
            }
        });
        ...
        const combinedData = {
            ...
            tags: Array.from(allTags), // Use aggregated tags
            author: 'Market Drip',
